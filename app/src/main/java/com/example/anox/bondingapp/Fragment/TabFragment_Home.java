...
public class TabFragment_Home extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
         ...
         */
            View x =  inflater.inflate(R.layout.tab_layout_home,null);
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        {
          switch (position){
              case 0 : return new Recommend_Fragment();
              case 1 : return new NewUsers_Fragment();
              case 2 : return new TabFragment_Search();
          }
        return null;
        }
